...
public class CompletaDiasActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completa_dias);
    ...
    public void onClick(View v) {
        ...
        if (id==R.id.uno){
            ...
            txt_completar.setBackgroundResource(R.drawable.txt_fridayc);
            ...
            Thread timerThread = new Thread(){
                public void run(){
                    try{
                        ...
                        Intent ir=new Intent(getApplicationContext(), SelectDias2Activity.class);
                        startActivity(ir);
                        finish();
                    }
                }
