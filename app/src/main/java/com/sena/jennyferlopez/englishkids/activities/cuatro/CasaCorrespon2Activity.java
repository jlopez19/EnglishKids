...
public class CasaCorrespon2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_casa_correspon2);
    ...
    public void onClick(View v) {
        ...
        if (id==R.id.uno){
            ...
            txt_completar.setBackgroundResource(R.drawable.txt_bedroomc);
            cargarPuntos();
            Thread timerThread = new Thread(){
                public void run(){
                    try{
                        ...
                        Intent ir=new Intent(getApplicationContext(), CasaCorrespon3Activity.class);
                        startActivity(ir);
                        finish();
                    }
                }
