...
public class CasaCorrespon4Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_casa_correspon4);
    ...
    public void onClick(View v) {
        ...
        if (id==R.id.tres){
            ...
            txt_completar.setBackgroundResource(R.drawable.txt_sundayc);
            cargarPuntos();
